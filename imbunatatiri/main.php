...
function email_imbunatatiri(){
	if (!$('#ascuns').val()){
		...
		$.ajax({type:'GET',url:'/includes/functii123.php?op=email_imbunatatiri'+query,success:function(raspuns){
				if (raspuns == 1){
...
<form id="form" onsubmit="return false;">
	<div class="span-21 form-header ui-corner-top">Trimite-ne un email cu sugestiile tale.</div>
...
<div class="span-23 box-main" style="margin-top: -20px;">
	<div class="span-20 text-xl">Noutati si imbunatatiri</div>
	<div class="span-21 box-noutati">
		<div class="span2 box-new ui-corner-top">
			<p class="text-new">26 Iul</p>
			<p>2010</p>
		</div>
		<div class="span-16 box-news">
			<p class="text-news">Lansarea programului de facturare online Facturi123</p>
			<p style="margin-bottom: 2px;">De azi este mult mai simplu sa emiti facturi. Te poti convinge vizitand <a href="/avantaje/" class="link">pagina de avantaje</a>.</p>
			<p>In plus, poti incerca gratuit Facturi123. Nu vei mai emite niciodata facturi pe suport de hartie!</p>
		</div>
	</div>
</div>

<div class="span-23 box-main box-helper" style="margin-top: -40px;">
	<div class="span-11">
