...
<div class="span-23 last box-table" style="margin-bottom: 30px;">
	<table border="0" id="tabel">
		<tr style="text-align: center; font-size: 1.2em;" class="tr-head ui-widget-header">
			<td class="rows-l span-10 ui-corner-tl" colspan="2">Denumire produs</td>
			<td class="rows-l span-3">UM</td>
			<td class="rows-l span-25">Cantitate</td>
			<td class="rows-l span-25" id="pret-h">Pret unitar</td>
			<td class="rows-l span-25 ui-corner-tr">Valoare</td>
		</tr>
<?php
if (isset($factura['facturi']['linii']['linie_attr'])){
	...
	echo '
		<tr class="tr-even" style="font-size: 1.2em;">
			...
			<td class="span-10 rind">'.$rp['denumire'].'</td>
			<td class="span-3 rind">'.$rp['unitate'].'</td>
			<td class="span-25 rind-r">'.$factura['facturi']['linii']['linie']['cantitate'].'</td>
	...
	for ($i=0; $i<(count($factura['facturi']['linii']['linie'])-1); $i++){
		...
		echo '
			...
			<td class="span-10 rind">'.$rp['denumire'].'</td>
			<td class="span-3 rind">'.$rp['unitate'].'</td>
			<td class="span-25 rind-r">'.$factura['facturi']['linii']['linie'][$i]['cantitate'].'</td>
...
<?php echo '<td class="rows span-5 init-subtotal">'.$factura['facturi']['total_valoare'].'</td>'; ?>				
		</tr>
		<tr style="font-weight: bold; font-size: 1.3em; text-align: right;">
<?php echo '<td class="rows span-16">Total General '.$valuta.'</td>'; ?>
<?php echo '<td class="rows">'.$factura['facturi']['total_general'].'</td>'; ?>
		</tr>
	</table>
