...
class MYPDF extends TCPDF {
	public function Header() {
		...
		$this->SetX($headerx);
		$this->SetTextColor(46,101,158);
		$this->Cell(19,6,'Cota TVA',0,0,'L');
		$this->SetTextColor(0,0,0);
		$this->Cell(30,6,$cota_tva,0,1,'L');
		$this->SetX($headerx);
		$this->SetTextColor(46,101,158);
...
$pdf->Cell(22.5,8,'UM',1,0,'C',1);
$pdf->Cell(20,8,'Cantitate',1,0,'C',1);
$pdf->Cell(22.5,8,'Pret unitar',1,0,'C',1);
$pdf->Cell(22.5,8,'Valoare',1,0,'C',1);
$pdf->Cell(22.5,8,'Valoare TVA '.$cota_tva,1,1,'C',1);
...
$pdf->Cell(22.5,5,'2',1,0,'C',1);
$pdf->Cell(20,5,'3',1,0,'C',1);
$pdf->Cell(22.5,5,'4',1,0,'C',1);
$pdf->Cell(22.5,5,'5',1,0,'C',1);
$pdf->Cell(22.5,5,'6',1,1,'C',1);
$y_linii = $pdf->GetY();
...
if (isset($factura['facturi']['linii']['linie_attr'])){
	...
	$pdf->SetXY(95,$y0);
	$pdf->Cell(22.5,$y,$rp['unitate'],'LR',0,'L',1,'',1,'',1);
	$pdf->Cell(20,$y,$factura['facturi']['linii']['linie']['cantitate'],'LR',0,'R',1,'',1);
	$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie']['pret'],'LR',0,'R',1,'',1);
	$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie']['valoare'],'LR',0,'R',1,'',1);
	$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie']['tva'],'LR',1,'R',1,'',1);
	
	$pdf->SetX(5);
	$pdf->Cell(10,12,'','LRB',0,'C',1,'',1);
	$pdf->Cell(80,12,'','LRB',0,'L',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',0,'L',1,'',1);
	$pdf->Cell(20,12,'','LRB',0,'R',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',0,'R',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',0,'R',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',1,'R',1,'',0);
}
else{
	for ($i=0; $i<(count($factura['facturi']['linii']['linie'])-1); $i++){
		...
		$pdf->SetXY(95,$y0);
		$pdf->Cell(22.5,$y,$rp['unitate'],'LR',0,'L',1,'',1,'',1);
		$pdf->Cell(20,$y,$factura['facturi']['linii']['linie'][$i]['cantitate'],'LR',0,'R',1,'',1);
		$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie'][$i]['pret'],'LR',0,'R',1,'',1);
		$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie'][$i]['valoare'],'LR',0,'R',1,'',1);
		$pdf->Cell(22.5,$y,$factura['facturi']['linii']['linie'][$i]['tva'],'LR',1,'R',1,'',1);
	...
	$pdf->Cell(22.5,12,'','LRB',0,'R',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',0,'R',1,'',1);
	$pdf->Cell(22.5,12,'','LRB',1,'R',1,'',1);
}

$y_adv = $pdf->GetY();
$pdf->Rect(5,$y_adv,112.5,26);
...
$pdf->SetXY(117.5,$y_adv);
$pdf->SetFont('helvetica','B',10);
$pdf->Cell(42.5,13,'Subtotal',1,0,'R');
$pdf->Cell(22.5,13,$factura['facturi']['total_valoare'],1,0,'R',1,'',1);
$pdf->Cell(22.5,13,$factura['facturi']['total_tva'],1,1,'R',1,'',1);
$pdf->SetX(117.5);
$pdf->Cell(42.5,13,'Total General '.$valuta,1,0,'R');
$pdf->Cell(45,13,$factura['facturi']['total_general'],1,1,'R',1,'',1);
