...
class MYPDF extends TCPDF {
	public function Footer() {
		...
		$this->SetXY(5,-20);
		$this->SetFont('helvetica','',7);
		if ($factura['facturi']['adv']['reprez_attr']['id'] || $factura['facturi']['adv']['delegat_attr']['id']){
			$this->Cell(83,3,'Document fiscal creat online de www.facturi123.ro',0,0,'L');
			$this->Cell(62,3,'Pagina '.$this->getAliasNumPage().' / '.$this->getAliasNbPages(),0,0,'L');
		}
		else{
...
$pdf->Cell(85.5,7.8,'Denumire produs',0,0,'C',1);
$pdf->Cell(.5,8,'',0,0);
$pdf->Cell(25.5,8,'UM',0,0,'C',1);
$pdf->Cell(.5,8,'',0,0);
$pdf->Cell(25.5,8,'Cantitate',0,0,'C',1);
$pdf->Cell(.5,8,'',0,0);
$pdf->Cell(30.5,8,'Pret unitar',0,0,'C',1);
$pdf->Cell(.5,8,'',0,0);
$pdf->Cell(30.5,8,'Valoare',0,1,'C',1);
$pdf->SetTextColor(0,0,0);
$pdf->SetDrawColor(0,0,0);
$pdf->SetFont('helvetica','',10);
...
if (isset($factura['facturi']['linii']['linie_attr'])){
	...
	$pdf->MultiCell(85.5,0,($i+1).'.  '.$rp['denumire'],0,'L',1,2);
	
	$y1 = $pdf->GetY();
	$y = $y1-$y0;
	$pdf->SetXY(90.5,$y0);
	$pdf->Cell(.5,$y,'',0,0);
	$pdf->Cell(25.5,$y,$rp['unitate'],0,0,'L',1,'',1);
	$pdf->Cell(.5,$y,'',0,0);
	$pdf->Cell(25.5,$y,$factura['facturi']['linii']['linie']['cantitate'],0,0,'R',1,'',1);
	$pdf->Cell(.5,$y,'',0,0);
	$pdf->Cell(30.5,$y,$factura['facturi']['linii']['linie']['pret'],0,0,'R',1,'',1);
	$pdf->Cell(.5,$y,'',0,0);
	$pdf->Cell(30.5,$y,$factura['facturi']['linii']['linie']['valoare'],0,1,'R',1,'',1);
}
else{
	for ($i=0; $i<(count($factura['facturi']['linii']['linie'])-1); $i++){
		...
		$pdf->Cell(25.5,$y,$rp['unitate'],0,0,'L',1,'',1);
		$pdf->Cell(.5,$y,'',0,0);
		$pdf->Cell(25.5,$y,$factura['facturi']['linii']['linie'][$i]['cantitate'],0,0,'R',1,'',1);
		$pdf->Cell(.5,$y,'',0,0);
		$pdf->Cell(30.5,$y,$factura['facturi']['linii']['linie'][$i]['pret'],0,0,'R',1,'',1);
		$pdf->Cell(.5,$y,'',0,0);
		$pdf->Cell(30.5,$y,$factura['facturi']['linii']['linie'][$i]['valoare'],0,1,'R',1,'',1);
...
$pdf->SetFont('helvetica','B',11);
$pdf->Cell(0,0,'',0,1);
$pdf->Cell(163,8,'Subtotal',0,0,'R');
$pdf->Cell(31.4,8,$factura['facturi']['total_valoare'],0,1,'R',0,'',1);
$pdf->Cell(163,8,'Total General '.$valuta,0,0,'R');
$pdf->Cell(31.4,8,$factura['facturi']['total_general'],0,1,'R',0,'',1);
$pdf->Cell(0,10,'',0,1);
