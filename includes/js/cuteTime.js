	...
	$.fn.cuteTime.settings = {
		...
		time_ranges: [
			{bound: NEG_INF,			// IMPORANT: bounds MUST be in ascending order, from negative infinity to positive infinity
					cuteness: 'the future!',		unit_size: 0},
			{bound: 0, 
					cuteness: '',			unit_size: 0},
			{bound: 20 * 1000, 
					cuteness: ' cateva secunde',	unit_size: 0},
			{bound: 60 * 1000, 
					cuteness: ' un minut',		unit_size: 0},
			{bound: 60 * 1000 * 2, 
					cuteness: ' minute',		unit_size: 60 * 1000},
			{bound: 60 * 1000 * 60, 
					cuteness: ' o ora',		unit_size: 0},
			{bound: 60 * 1000 * 60 * 2, 
					cuteness: ' ore',			unit_size: 60 * 1000 * 60},
			{bound: 60 * 1000 * 60 * 24, 
					cuteness: 'o zi',			unit_size: 0},
			{bound: 60 * 1000 * 60 * 24 * 2, 
					cuteness: ' zile',			unit_size: 60 * 1000 * 60 * 24},
			{bound: 60 * 1000 * 60 * 24 * 30,	
					cuteness: 'o luna',			unit_size: 0},
			{bound: 60 * 1000 * 60 * 24 * 30 * 2, 
					cuteness: ' luni',		unit_size: 60 * 1000 * 60 * 24 * 30},
			{bound: 60 * 1000 * 60 * 24 * 30 * 12, 
					cuteness: 'un an',			unit_size: 0},
			{bound: 60 * 1000 * 60 * 24 * 30 * 12 * 2, 
					cuteness: ' ani',			unit_size: 60 * 1000 * 60 * 24 * 30 * 12},
			{bound: POS_INF, 
					cuteness: 'a blinkle ago',		unit_size: 0}
		]
	};
		...
		jQuery.each(time_ranges, function(i, timespan) {
			if (i < time_ranges.length-1) {
				if ((	time_difference		>=		timespan['bound']) &&
					...
					cute_time = 'acum ' + calculated_time + timespan['cuteness'];
